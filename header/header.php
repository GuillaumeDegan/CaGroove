...
<body>
    <nav class="nav bg-orange-500	h-32  flex">
        <div class="link_container flex items-center place-content-evenly w-full ">
...
<div class="text-white flex items-center place-content-evenly w-10/12 ">
